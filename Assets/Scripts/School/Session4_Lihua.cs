...
public class Session4_Lihua : MonoBehaviour {
    ...
    void Start () {
        //how do we instantiate (make )a new prefab?_give a object position,rotation and parent
    ...
    IEnumerator DropPrefabsFromHeight()
    {
        while (true)
        {
            Vector3 prefabPos = new Vector3(UnityEngine.Random.Range(0, 10), UnityEngine.Random.Range(0, 10), UnityEngine.Random.Range(0, 10));
